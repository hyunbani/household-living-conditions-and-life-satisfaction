...
$$y_i=\beta_0+\beta_1{x_i}_1+\beta_2{x_i}_2+\beta_3{x_i}_3+\beta_4{x_i}_4+\beta_5{x_i}_5+\beta_6{x_i}_6+\epsilon$$
where, for $i=20331$ observations:\
$y_i=$ dependent variable\
$x_i=$ explanatory variables\
$\beta_0=$ y-intercept (constant term)\
$\beta_1...\beta_6=$ slope coefficients for each explanatory variable\
